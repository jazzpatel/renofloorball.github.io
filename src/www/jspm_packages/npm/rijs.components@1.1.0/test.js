...
var expect = require('chai').expect,
    ...
    components = require('./dist/index').default,
...
describe('Custom Elements', function() {
  ...
  it('should draw a d3 node', function(done) {
    var el1 = once(container)('component-3', 1).node(),
        ...
        result1,
        result2;
    ripple('component-3', function() {
      result1 = this;
    });
    ripple('component-4', function() {
      result2 = this;
    });
  ...
  it('should draw a resource with single datum', function(done) {
    var el = once(container)('component-5[data="array"]', 1).node(),
        ...
        result;
    ripple('array', [1, 2, 3]);
    ripple('component-5', function(n, d) {
      result = d;
    });
    time(20, function() {
  ...
  it('should draw a resource with multiple data', function(done) {
    ...
    ripple('component-6', function(n, d) {
      result = d;
    });
    time(20, function() {
  ...
  it('should draw a resource with d3 datum', function(done) {
    var el = once(container)('component-7', 1).node(),
        ...
        result;
    el.__data__ = {foo: 'bar'};
    ripple('component-7', function(n, d) {
      result = d;
    });
    time(20, function() {
  ...
  it('should draw a resource with local state', function(done) {
    ...
    ripple('component-8', function(n, d) {
      result = d;
    });
    time(20, function() {
  ...
  it('should draw a resource with combined data', function(done) {
    ...
    el.state = {focused: true};
    ripple('array', [1, 2, 3]);
    ripple('component-9', function(n, d) {
      result = d;
    });
    time(20, function() {
      expect(result).to.eql({
  ...
  it('should draw a resource by name (data)', function(done) {
    ...
    ripple('array', [1, 2, 3]);
    ripple('object', {foo: 'bar'});
    ripple('component-10', function(d) {
      result1 = this;
    });
    ripple('component-11', function(d) {
      result2 = this;
    });
    ripple('component-12', function(d) {
      result3 = this;
    });
  ...
  it('should draw everything', function(done) {
    ...
    ripple('array');
    ripple('object');
    ripple('component-14', function() {
      result1 = this;
    });
    ripple('component-15', function() {
      result2 = this;
    });
    ripple('component-16', function() {
      result3 = this;
    });
  ...
  it('should pass root as parameter', function(done) {
    ...
    ripple('component-29', function(n, d) {
      result1 = n;
    });
    ripple('component-30', function(n, d) {
      result2 = n;
    });
    time(40, function() {
  ...
  it('should render class component', function(done) {
    ...
    time(40, function() {
      ...
      expect(init).to.be.eql({
        this: el,
        node: el
      });
      expect(render).to.be.eql({
        this: el,
        node: el,
        state: {}
      });
  ...
  it('should render class component with async init', function(done) {
    ...
    ripple('component-class-async-init', class component3 {
      init(node) {
        return Promise.resolve('foo').then((foo) => node.state = {foo});
      }
      render(node, state) {
