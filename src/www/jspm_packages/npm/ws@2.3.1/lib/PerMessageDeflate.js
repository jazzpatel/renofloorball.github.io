  ...
  class PerMessageDeflate {
    ...
    decompress(data, fin, callback) {
      ...
      if (!this._inflate) {
        ...
        this._inflate = zlib.createInflateRaw({windowBits: typeof maxWindowBits === 'number' ? maxWindowBits : DEFAULT_WINDOW_BITS});
      }
      ...
      this._inflate.flush(() => {
        ...
        if (err)
          ...
          callback(null, bufferUtil.concat(buffers, totalLength));
      });
    }
