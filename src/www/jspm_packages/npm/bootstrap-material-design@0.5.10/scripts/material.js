  ...
  (function($) {
    ...
    function _isChar(evt) {
      if (typeof evt.which == "undefined") {
        ...
        return (!evt.ctrlKey && !evt.metaKey && !evt.altKey && evt.which != 8 && evt.which != 9 && evt.which != 13 && evt.which != 16 && evt.which != 17 && evt.which != 20 && evt.which != 27);
      }
      return false;
    }
    ...
    function _toggleTypeFocus($input) {
      ...
      $input.closest('label').hover(function() {
        ...
        var isDisabled = $i.prop('disabled');
