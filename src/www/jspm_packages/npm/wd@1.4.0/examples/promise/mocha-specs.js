...
describe('mocha spec examples', function() {
  ...
  describe("using promises and chai-as-promised", function() {
    ...
    it("submit element should be clicked", function() {
      return browser.elementById("submit").click().eval("window.location.href").should.eventually.include("&submit");
    });
  });
  describe("regular mocha usage", function() {
    ...
    beforeEach(function(done) {
      browser.get("http://admc.io/wd/test-pages/guinea-pig.html").nodeify(done);
    });
    after(function(done) {
    ...
    it("submit element should be clicked", function(done) {
      browser.elementById("submit").click().eval("window.location.href").then(function(location) {
