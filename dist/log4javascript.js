...
var LoggingEvent=function LoggingEvent(logger,timeStamp,level,messages,
exception){
this.logger=logger;
...
setKeys:function setKeys(loggerKey,timeStampKey,levelKey,messageKey,
...
}else if((typeof obj==="undefined"?"undefined":_typeof(obj))=="object"&&array_contains(objectsExpanded,obj)){
try{
expansion=toStr(obj);
}catch(ex){
...
return obj.toString();
}else if((typeof obj==="undefined"?"undefined":_typeof(obj))=="object"&&depth>0){
objectsExpanded.push(obj);
expansion="{"+newLine;
childDepth=depth-1;
childIndentation=indentation+"  ";
...
var xhrFactory=function xhrFactory(){return new XMLHttpRequest();};
...
try{
var windowTest=function windowTest(win){return isLoaded(win);};
if(useDocumentWrite){
...
var popUpLoadedTest=function popUpLoadedTest(win){return bool(win)&&isLoaded(win);};
if(isLoaded(popUp)){
finalInit();
}else{
...
},undefined);;var _temp=function(){if(typeof __REACT_HOT_LOADER__==='undefined'){return;}}();;
